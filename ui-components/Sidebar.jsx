            ...
            >
              ...
              >
                ...
                >
                  <Text
                    ...
                    whiteSpace="pre-wrap"
                    children="Notebooks"
                    {...getOverrideProps(overrides, "Text39793168")}
                  ></Text>
                  <MyIcon
                    width="24px"
                    height="24px"
                    ...
                    padding="0px 0px 0px 0px"
                    type="BiBookAdd"
                    {...getOverrideProps(overrides, "MyIcon39793169")}
                  ></MyIcon>
                </Flex>
                <Divider
                  width="unset"
              ...
              >
                <Notebookitem
                  ...
                  padding="0px 0px 0px 0px"
                  isOpen={true}
                  {...getOverrideProps(overrides, "Notebook item40302618")}
                ></Notebookitem>
                <Notebookitem
                  display="flex"
                  gap="10px"
                  ...
                  padding="0px 0px 0px 0px"
                  isOpen={false}
                  {...getOverrideProps(overrides, "Notebook item40302645")}
                ></Notebookitem>
                <Notebookitem
                  display="flex"
                  gap="10px"
                  ...
                  padding="0px 0px 0px 0px"
                  isOpen={false}
                  {...getOverrideProps(overrides, "Notebook item40302675")}
                ></Notebookitem>
                <Notebookitem
                  display="flex"
                  gap="10px"
                  ...
                  padding="0px 0px 0px 0px"
                  isOpen={false}
                  {...getOverrideProps(overrides, "Notebook item40302707")}
                ></Notebookitem>
              </View>
            </Flex>
          </Flex>
            ...
            >
              ...
              >
                ...
                <Text
                  ...
                  whiteSpace="pre-wrap"
                  children="Support"
                  {...getOverrideProps(overrides, "Text39793176")}
                ></Text>
              </Flex>
            </Flex>
            <Flex
            ...
            >
              ...
              >
                <MyIcon
                  ...
                  padding="0px 0px 0px 0px"
                  type="BiChevronLeft"
                  {...getOverrideProps(overrides, "MyIcon39793179")}
                ></MyIcon>
                <Text
                  fontFamily="Inter"
                  fontSize="16px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Collapse"
                  {...getOverrideProps(overrides, "Text39793180")}
                ></Text>
              </Flex>
            </Flex>
          </View>
