    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const notes = await DataStore.save(new Notes(modelFieldsToSave))
          const promises = []
          promises.push(
      ...
      <TextAreaField
        ...
        {...getOverrideProps(overrides, "content")}></TextAreaField>
      <ArrayField
        ...
        <Autocomplete
          ...
          ref={TagsRef}
          labelHidden={true}
          {...getOverrideProps(overrides, "Tags")}></Autocomplete>
      </ArrayField>
      <Flex
